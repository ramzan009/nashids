<div class="col-md-12" style="padding: 0">
    <form method="GET" action="{{ route('order-work-report') }}">
        <div class="card" style="margin-bottom: 5px;">
            <div class="card-body row">
                <div class="form-group col-md-4">
                    <label>Период от</label>
                    <input type="text" name="from" id="from" placeholder="ДД-ММ-ГГГГ" value="" class="form-control"
                           pattern="^[0-9]{2}-[0-9]{2}-[0-9]{4}$">
                </div>
                <div class="form-group col-md-4">
                    <label>До</label>
                    <input type="text" name="to" id="to" placeholder="ДД-ММ-ГГГГ" value="" class="form-control"
                           pattern="^[0-9]{2}-[0-9]{2}-[0-9]{4}$">
                </div>
                <div class="form-group col-md-4">
                    <label>Почта</label>
                    <input type="email" required name="email" id="email" placeholder="example@mail.ru"
                           class="form-control">
                </div>
            </div>
        </div>
